<template>
    ...
    <Modal v-model="deleteVisible" :closable="false" :mask-closable="false" class="resume-delete-modal" footer-hide>
    ...
    <Modal v-model="editVisible" :closable="false" :mask-closable="false" class="resume-delete-modal" footer-hide>
        <div class="delete-box">
            <div class="delete-content">
                <div class="delete-header">
                    <h3 class="delete-title mb-40">提示</h3>
...
const handleClick = (resume: MyResumeBean, key: string) => {
    ...
    switch (key) {
        case 'preview':
            ...
            break;
        case 'edit':
            if (resume.aiProcessing === '1') {
                message.warning(Message, '简历正在解析中，请刷新状态后再试!');
                return;
            }
...
.resume-content {
    ...
    box-shadow: 0 0 6.625px 0 rgba(0, 0, 0, 0.1);
    border-radius: vw(2);
    position: relative;
}
