...
<template>
  <div class="test-container">
    ...
    <div class="form-group">
      <label>渠道名称:</label>
      <input v-model="channelName" type="text" placeholder="如: boss, zhipin, linkedin" />
    </div>

    <div class="form-group">
      <label>Cookies:</label>
      <textarea v-model="cookies" rows="3" placeholder="输入 Cookie 字符串"></textarea>
    </div>

    <div class="button-group">
      <button @click="testSave" class="btn-primary">保存 Cookies</button>
      <button @click="testGet" class="btn-secondary">获取指定渠道</button>
      <button @click="testGetAll" class="btn-info">获取所有渠道</button>
    </div>
    <div class="button-group">
      <button @click="login('boss')" class="btn-info">boss登录</button>
      <button @click="login('zhilian')" class="btn-info">智联登录</button>
      <button @click="login('guopin')" class="btn-info">国聘登录</button>
    </div>
    <div class="button-group">
      <button @click="bossPosition" class="btn-info">boss职位</button>
      <button @click="zhilianPosition" class="btn-info">智联职位</button>
      <button @click="guopinPosition" class="btn-info">国聘职位</button>
    </div>
    <div class="button-group">
      <button @click="crPosition" class="btn-info">爬职位</button>
    </div>
    <div class="button-group">
